...
public final class Joystick {
    ...
    public func handleKeyDown(keyCode: UInt16) -> Bool {
        ...
        case 91:  press(bit: 0x01); return true  // Numpad 8 = Up
        case 84:  press(bit: 0x02); return true  // Numpad 2 = Down
        case 86:  press(bit: 0x04); return true  // Numpad 4 = Left
        case 88:  press(bit: 0x08); return true  // Numpad 6 = Right
        case 82:  press(bit: 0x10); return true  // Numpad 0 = Fire
        case 83:  press(bit: 0x10); return true  // Numpad Enter = Fire
    ...
    public func handleKeyUp(keyCode: UInt16) -> Bool {
        switch keyCode {
        case 91:  release(bit: 0x01); return true
        case 84:  release(bit: 0x02); return true
        case 86:  release(bit: 0x04); return true
        case 88:  release(bit: 0x08); return true
        case 82:  release(bit: 0x10); return true
        case 83:  release(bit: 0x10); return true
        default:  return false
        }
    }
