...
| Tape | Container-level | T64/TAP mounting, trap loading, and CPU-port cassette sense/write/motor line surfaces exist; real datasette signal timing is not complete. |
