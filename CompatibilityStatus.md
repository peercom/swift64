...
| CIA 6526 | Partial | Timers, TOD, keyboard/joystick scanning, FLAG/CNT/SP serial paths, PB6/PB7 timer outputs, interrupt masking, and timer read latches are covered; TOD 50/60 Hz profile closure and deeper port interactions remain open. |
