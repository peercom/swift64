...
| Tape | Early signal foundation | T64 trap loading, raw TAP v0/v1 pulse parsing, and CPU-port cassette sense/write/motor line surfaces exist; real datasette signal timing is not complete. |
